...
export const metadata: Metadata = {
  ...
  description: "Vigmis Privacy Policy — how we collect, use, and protect your data.",
};

function Section({ title, body }: { title: string; body: string }) {
  // Split on \n\n for paragraphs / bullet blocks
    ...
    <>
      ...
      <main>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          {/* Intro */}
          <div className="mb-10 p-6 bg-primary/5 border border-primary/15 rounded-2xl">
